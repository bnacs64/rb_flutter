...
class _KidsScreenState extends State<KidsScreen> {
  ...
  Future<void> _loadKidsProducts() async {
    try {
      ...
      // Load products from kids category or search for kids products
      final products = await _productService.searchProducts('kids', limit: 20);
            ...
            if (_isLoading)
              ...
              SliverToBoxAdapter(
                child: Padding(
                  ...
                  child: Text(
                    'Error loading kids products: $_error',
                    style:
              ...
              const SliverToBoxAdapter(
                child: Padding(
                  padding: EdgeInsets.all(defaultPadding),
                  child: Text('No kids products found'),
                ),
              )
            else
              SliverPadding(
